    ...
    <div className='p-4 sm:p-6 lg:p-8 space-y-8'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6'>
        {quickStats.map((stat, index) => (
          <div
            key={index}
            className={`flex flex-col items-center justify-center p-6 rounded-xl shadow-md ${stat.bgColor}`}
          >
            <p className='text-sm font-medium text-gray-600'>{stat.title}</p>
            <h4 className='text-3xl font-extrabold text-gray-800 my-1'>
              {stat.value}
            </h4>
      ...
      <Card title='Weekly Outbound Unit Shipments' className='h-[400px]'>
        <ResponsiveContainer width='100%' height='90%'>
          ...
          >
            ...
            <Area
              type='monotone'
              dataKey='UnitsShipped'
              stroke='#CD853F'
              fillOpacity={1}
              fill='url(#colorUvDark)'
              name='Units Shipped'
            />
            <defs>
